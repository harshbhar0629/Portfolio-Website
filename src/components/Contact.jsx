...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				personalInfo.SERVICE_ID,
				personalInfo.TEMPLATE_ID,
				{
					from_name: form.name,
					to_name: "Harsh Bhardwaj",
					from_email: form.email,
					to_email: personalInfo.MY_EMAIL,
					message: form.message,
				},
				personalInfo.PUBLIC_ID
			)
			.then(
				() => {
					setLoading(false);
		...
		<div className=" bg-black-100 p-8">
			<div
				...
				<motion.div
					...
					<p className={styles.sectionSubText}>Get in touch via mail:</p>
